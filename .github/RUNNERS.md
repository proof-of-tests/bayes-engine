...
#### Option B: Using Registration Token (More Secure)
...
# Modify setup-runner.sh to use the registration token directly
# or follow GitHub's manual setup instructions
```
